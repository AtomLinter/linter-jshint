...
module.exports = {
  ...
  activate() {
    ...
    this.subscriptions.add(atom.config.observe('linter-jshint.jshintFilePath', jshintFilePath => {
      this.jshintFilePath = jshintFilePath
    }))
  ...
  provideLinter(): Linter$Provider {
    ...
    return {
      ...
      lint: async (textEditor) => {
        ...
        configFile = await Helpers.findCachedAsync(Path.dirname(filePath), this.jshintFilePath)
        if (configFile) {
